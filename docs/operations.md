...
paths (preferring the larger live copy), presents the result through one temporary `CODEX_HOME`,
and writes it to `codex-multica.json`. Multica also relocates dsh logs to
