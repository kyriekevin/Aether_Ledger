...
- `data/{work,personal,devbox}/statistics.json` is generated by the opt-in statistics collector.
  Its private SQLite journal must never be committed.
- `data/{work,personal,devbox}/issue-activity.json` is generated; never commit its private event journal.
- `data/multica-dispatch.json` is generated by `scripts/multica_dispatch.py`; never hand-edit it.
