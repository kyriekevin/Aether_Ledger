...
- Treat `data/{work,personal,devbox}/{claude,codex,codex-multica,dsh-multica,opencode,traex,dsh}.json` and `data/trail/**` as generated cumulative stores.
  Do not hand-edit them.
- Retained statistics and task metadata under `data/` are generated snapshots. Do not hand-edit
  them or commit their private journals. They do not contribute to token totals.
- Treat `assets/token-activity.svg` as generated. Change `scripts/render_dashboard.py`, then
